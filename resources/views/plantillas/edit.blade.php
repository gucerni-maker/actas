        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 text-dark">Editar Plantilla de Acta</h5>
                    <a href="{{ route('plantillas.index') }}" class="btn btn-secondary btn-sm">
                        <i class="fas fa-arrow-left"></i> Volver
                    </a>
                </div>
                <div class="card-body">
                    <form action="{{ route('plantillas.update', $plantilla) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nombre') is-invalid @enderror" 
                                   id="nombre" name="nombre" value="{{ old('nombre', $plantilla->nombre) }}" required>
                            @error('nombre')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('texto_introduccion') is-invalid @enderror" 
                                      id="texto_introduccion" name="texto_introduccion" rows="4">{{ old('texto_introduccion', $plantilla->texto_introduccion) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('texto_confidencialidad') is-invalid @enderror" 
                                      id="texto_confidencialidad" name="texto_confidencialidad" rows="4">{{ old('texto_confidencialidad', $plantilla->texto_confidencialidad) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('encabezado_personalizado') is-invalid @enderror" 
                                      id="encabezado_personalizado" name="encabezado_personalizado" rows="3">{{ old('encabezado_personalizado', $plantilla->encabezado_personalizado) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('pie_personalizado') is-invalid @enderror" 
                                      id="pie_personalizado" name="pie_personalizado" rows="3">{{ old('pie_personalizado', $plantilla->pie_personalizado) }}</textarea>
                        ...
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input @error('activa') is-invalid @enderror" 
                                   id="activa" name="activa" {{ old('activa', $plantilla->activa) ? 'checked' : '' }}>
