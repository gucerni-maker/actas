    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
          ...
          <a class="btn btn-sm btn-outline-dark"><i class="fas fa-plus"></i> Nuevo Servidor</a>
        </div>
        <div class="card-body">
              ...
              <div class="col-md-8">
                <div class="input-group">
                  <input type="text" class="form-control" name="buscar"
                    placeholder="Buscar por IP, Oficina, Sistema Operativo, Tipo, etc."
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex gap-1">
                      ...
                      <button type="submit" class="btn btn-sm btn-secondary me-1 btn-outline-light" style="color:#222">
