    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
          ...
          <a class="btn btn-sm btn-outline-dark"><i class="fas fa-plus"></i>Nuevo Encargado</a>
        </div >
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex gap-1">
                      <a href="{{ route('programadores.show', $programador) }}" class="btn btn-sm btn-outline-light" style="color:white-50;">
