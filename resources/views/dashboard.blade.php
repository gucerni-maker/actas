      ...
      <div class="card border-start border-white shadow h-100 py-2 dashboard-card">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-uppercase mb-1" style="color:#ccc;">
                Total Actas
              </div>
              <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $totalActas }}</div>
              <div class="mt-2">
                <a href="{{ route('actas.index') }}" class="btn btn-sm btn-outline-light">
                  Ver todas
                </a>
              </div>
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="mt-2">
                <a href="{{ route('programadores.index') }}" class="btn btn-sm btn-outline-light">
                  Ver todos
                </a>
              </div>
            </div>
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="mt-2">
                <a href="{{ route('servidores.index') }}" class="btn btn-sm btn-outline-light">
                  Ver todos
                </a>
              </div>
            </div>
    ...
    <div class="col-12">
      <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          ...
          <div>
            <h6 class="m-0 font-weight-bold text-dark">
              <a class="btn btn-sm btn-outline-dark"><i class="fas fa-plus me-1"></i> Nueva Acta</a>
              <a class="btn btn-sm btn-outline-dark"><i class="fas fa-upload me-1"></i> Cargar Acta Existente</a>
              <a class="btn btn-sm btn-outline-dark"><i class="fas fa-file-signature me-1"></i> Crear Plantilla</a>
            </h6>
          </div>
        </div>
        <div class="card-body">
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a  class="btn btn-sm me-1 btn-outline-light">
                      <i class="fas fa-plus me-1"></i> Crear Acta
                    </a>
                    <a  class="btn btn-sm btn-secondary me-1 btn-outline-light" style="color:#222">
                      <i class="fas fa-upload me-1"></i> Cargar Acta
                    </a>
                    <a href="{{ route('servidores.show', $servidor) }}" class="btn btn-sm btn-outline-light" style="color:white-50;">
                      <i class="fas fa-eye"></i> Detalles
                    </a>
                  </td>
                </tr>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    @endphp
                    <span class="badge bg-{{ $diasTranscurridos > 7 ? 'secondary' : ($diasTranscurridos > 3 ? 'secondary' : 'info') }}">
